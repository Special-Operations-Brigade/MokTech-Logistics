...
/*
Function: mti_logistics_fnc_vehicle_dialogPFH
...
//TRACE_CHAT_7("logibox vars",_inProgress,_inProgressTime,_deployedHash,_coolDown,_owner,_outputClear,_curSel);
...
private _limit = ["Vehicles",_curSelVehicle,"limit"] call FUNC(getConfigProperty);
